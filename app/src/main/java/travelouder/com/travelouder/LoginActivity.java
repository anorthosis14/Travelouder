...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    private static final int RC_SIGN_ING = 9001;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       setContentView(R.layout.activity_login);
        ...
        Button btnSign_out = findViewById(R.id.sign_out_button);
        mStatusTextView = findViewById(R.id.status);
        mStatusTextView.setText("");
        findViewById(R.id.sign_in_button).setOnClickListener(this);
        // Views
        //mDetailTextView = findViewById(R.id.);
...
//        String drinkTonight = stefanosWants && marekDoesntMaybeWantYes ? "we drink" : "we definitely drink"
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Sign in success, update UI with the signed-in user's informationn
    ...
    private void signInG() {
        ...
        startActivityForResult(signInIntent, RC_SIGN_ING);
    }
    // [END signin]
